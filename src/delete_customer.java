 ...
 * @author Betül Kul
 */
public class delete_customer extends javax.swing.JDialog {
    DefaultTableModel model = new DefaultTableModel();
    Operation op5 = new Operation();
    /**
     * Creates new form delete_customer
     */
    public delete_customer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        if (cust_table.getColumnModel().getColumnCount() > 0) {
            cust_table.getColumnModel().getColumn(0).setResizable(false);
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(message, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void delete_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_buttonActionPerformed
        int selectedRow = cust_table.getSelectedRow();
        if(selectedRow == -1){
            if(model.getRowCount()==0){
                message.setText("Customer table is empty!");
            }
            else{
                message.setText("Choose a customer to delete!");
            }
        }
        else{
            String cid =(String) model.getValueAt(selectedRow, 0);
            op5.deleteCustomer(cid);
            custView();
            message.setText("Customer is deleted");
        }
    ...
    if(custs != null){
        for(Customer cust_list : custs){
            Object[] add = {
            cust_list.getCust_id()
            };
        model.addRow(add);
        }}}
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                delete_customer dialog = new delete_customer(new javax.swing.JFrame(), true);
